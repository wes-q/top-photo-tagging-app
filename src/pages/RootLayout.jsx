...
export default function RootLayout({ notification, type, user, setNotification }) {
    ...
    return (
        <div className="flex flex-col min-h-screen h-full bg-slate-600 text-white text-sm sm:text-base font-nunito">
            <header>
                <nav className="w-full sm:justify-between sm:items-center p-6 bg-gray-800  specific sm:text-lg">
                    ...
                    {isExpanded && (
                        ...
                        >
                            <NavLink className="text-cyan-400 bg-gray-800 rounded-md px-4 py-1 uppercase" to="/">
                                anecdotes
                            </NavLink>
                            <NavLink className="text-cyan-400 bg-gray-800 rounded-md px-4 py-1 whitespace-nowrap uppercase" to="/create">
                                create new
                            </NavLink>
                            <NavLink className="text-cyan-400 bg-gray-800 rounded-md px-4 py-1 uppercase" to="/about">
                                about
                            </NavLink>
                        </motion.div>
                    )}
            ...
            <main className="h-full grow p-2">
